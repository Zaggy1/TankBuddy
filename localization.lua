...
elseif (GetLocale() == "deDE") then -- German
	...
	TB_GUI_EnterNewText = {
		...
		[TB_GUI_Growl] = "Neuer Benachrichtigungstext wenn Knurren wiederstanden wird:"
	}
	TB_GUI_EnableSalvation = "SdR entfernen"; 
	TB_GUI_SalvationDefensive = "Nur in DefStance"; 
	TB_GUI_SalvationBear = "Nur in Bärenform"; 
	...
	TB_defaultText_g = "- Mein Spott wurde von $tn widerstanden -"; 
	...
	TB_mbCrit = "Sp\195\182ttischer Schlag trifft (.+) kritisch: (.+)"
	...
	TB_salvation = "Ihr bekommt Segen der Rettung";

	TB_output_salvation = "Segen der Rettung entfernt";
